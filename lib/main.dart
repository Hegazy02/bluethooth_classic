      ...
      _bluetoothClassicPlugin.onDeviceDiscovered().listen(
        (event) {
          if (!_discoveredDevices
              .any((element) => element.address == event.address)) {
            setState(() {
              _discoveredDevices = [..._discoveredDevices, event];
              log("_discoveredDevices: $_discoveredDevices");
            });
          }
        },
      );
              ...
              ...[
                for (var device in _discoveredDevices)
                  ElevatedButton(
                      ...
                      child: Text(device.name ?? device.address + "sdasdkaslk"))
              ],
              TextButton(
                onPressed: _scan,
